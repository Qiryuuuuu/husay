...
const storyScenes = {
  ...
  round1: [
    ...
    },
    {
      ...
      background: shaneProblem2Bg,
      character: "EVA",
      dialogues: ["I must do something. Think, EVA, think. pause"],
      audio: [
  ...
  round5: [
    ...
    },
    {
      ...
      character: "SHANE",
      dialogues: [
        "Whewwwww, that’s a good sleep. EVA, where am I??? Why are you crying?",
      ],
      audio: [
    ...
    },
    {
      ...
      character: "EVA",
      dialogues: [
        "The Evil Inventor got you three. You are the one that is captured first.",
      ],
      audio: [
    ...
    },
    {
      ...
      character: "SHANE",
      dialogues: [
        "Really??? Why can’t I remember a thing? So, this is the Inventor’s lair? ",
      ],
    },
    {
      type: FrameType.FOLLOWING,
      ...
      character: "EVA",
      dialogues: [
        "Yes, and right now, I’m going to find Dolor and Amber. Say hi to my friend here.",
      ],
      audio: [
    ...
    },
    {
      ...
      character: "SHANE",
      dialogues: [
        "Hiiii, thanks for taking good care of EVA. waves to the screen",
      ],
      audio: [
  ...
  round10: [
    ...
    },
    {
      ...
      character: "EVA",
      dialogues: ["I think she’s waking up. Dolor, can you hear us?"],
    },
    {
      type: FrameType.INCORRECT_ANSWER,
    ...
    },
    {
      ...
      background: dolorCorrectBg,
      character: "DOLOR",
      dialogues: ["Why? What happened?"],
    },
    {
      type: FrameType.FOLLOWING,
      background: dolorCorrectBg,
      character: "SHANE",
      dialogues: ["She said we got captured."],
    },
    {
      type: FrameType.FOLLOWING,
      background: dolorCorrectBg,
    ...
    },
    {
      ...
      dialogues: ["What?!!! That means Techtopia became vulnerable."],
    },
    {
      type: FrameType.FOLLOWING,
      background: dolorCorrectBg,
      character: "EVA",
      dialogues: [" It was. The kids gave me courage to rescue you. "],
    },
    {
      type: FrameType.FOLLOWING,
      background: dolorCorrectBg,
      character: "SHANE & DOLOR",
      dialogues: ["Oh my stars. That's why you’re crying."],
    },
    {
      type: FrameType.FOLLOWING,
      background: dolorCorrectBg,
      character: "EVA",
      dialogues: ["Come on, we must save Amber."],
    },
  ],
  ...
  round11: [
    {
      ...
      character: "DOLOR",
      dialogues: ["Shane—EVA—I saw Amber. She’s locked up in this room. "],
      audio: [
    ...
    },
    {
      ...
      character: "EVA",
      dialogues: [
        "I think she’s waking up. Amber, there’s food in front of you.",
      ],
    },
    {
      type: FrameType.INCORRECT_ANSWER,
    ...
    },
    {
      ...
      character: "EVA",
      dialogues: [
        "You’re welcome. This is far from over. We must capture the Evil Inventor so that he can stop bugging us. Are you with me?",
      ],
    },
    {
      type: FrameType.FOLLOWING,
  ...
  outro: [
    ...
    },
    {
      ...
      character: "EVIL INVENTOR",
      dialogues: [
        "Uhhh uhhh uhhh. No. *activates magnet* I think you think I have no plan. My plan was to capture all of you. Why do you think I’m here in this room?",
      ],
      audio: [
    ...
    },
    {
      ...
      character: "EVIL INVENTOR",
      dialogues: [
        "Because!!!—*activates the room’s magnet* this whole room is a magnet, and you all are a bunch of cheap metal. Wahahahahahahahaha. My plan has worked. I now have Techtopia in my hands. Now, let me re-delete all of your memories.",
      ],
      audio: [
    ...
    },
    {
      ...
      character: "EVA",
      dialogues: [
        "I know. Make yourself hot, like you have the worst fever ever.",
      ],
      audio: [
    ...
    },
    {
      ...
      character: "EVIL INVENTOR",
      dialogues: [
        "Why is it so hot here? *turns back* Wha—what. How did you break free?",
      ],
      audio: [
    ...
    },
    {
      ...
      character: "AMBER",
      dialogues: [
        "I think you’re forgetting that we’re robots. We have the knowledge of those before us. Heat weakens magnets.",
      ],
      audio: [
    ...
    },
    {
      ...
      character: "SHANE",
      dialogues: [
        "You and your food. But yeahhh, can we go back now? I wanna play with the kids.",
      ],
      audio: [
    ...
    },
    {
      ...
      character: "EVA",
      dialogues: [
        "Sureee. Let's go back home. We have some animal friends coming over. It’s a feast.",
      ],
      audio: [
    ...
    },
    {
      ...
      character: "EVA",
      dialogues: [
        "Thank you my friend for reuniting me with my friends. If you got time, wanna join us here in Techtopia?",
      ],
      audio: [
